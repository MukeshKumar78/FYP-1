...
INSERT INTO base_society (code, name, full_name, description, image, created_at) VALUES ('test', 'TS', 'Test Society', 'a society for testing', 'https://picsum.photos/500', '2023-01-01 00:00:01-00');
INSERT INTO society (code, name, full_name, description, image, tenure_id, base_id, created_at) VALUES ('test-spring-2023', 'TS', 'Test Society', 'a society for testing', 'https://picsum.photos/500', 1, 1, '2023-01-01 00:00:01-00');
